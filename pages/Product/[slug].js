          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <button className="flex mx-1 md:mx-3 text-white bg-indigo-500 border-0 py-2 px-1 md:px-6 focus:outline-none hover:bg-indigo-600 rounded">Add to Cart</button>
